...
if num_str == "2":
    ...
    num_int = int(num_str)
    print("I don't know how to handle negative nunbers!")
else:
...
# case sensitive in this case?
    # becuase the word NO does not end the function, it's just a placeholder for input that is not represented as output
