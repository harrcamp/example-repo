...
# program will always return printed statement becuase "bond" is truthy becuase python evaluates this as elif calculation_type != ()"investment") or ("bond"):
elif calculation_type != "investment" or "bond":
